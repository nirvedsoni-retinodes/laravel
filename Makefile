.PHONY: up down build install migrate seed link start-workers start-scheduler test clean

up: build install migrate seed link start-workers start-scheduler
