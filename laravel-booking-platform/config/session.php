...
return [
    ...
    |
    | Supported: "file", "database", "apc", "memcached", "redis", "dynamodb",
    |            "array"
    |
    */
    ...
    */
    ...
    | for you; however, you are free to change this as needed.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | While using one of the cache drivers, you may specify which cache
    | store should be used for these sessions. This value must correspond
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value determines the domain on which the cookie will be available.
    | Setting this to a subdomain such as 'www.example.com' will make the
    | cookie available on the subdomain and all other subdomains of it.
    |
    */
